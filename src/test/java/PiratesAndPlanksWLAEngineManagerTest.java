...
public class PiratesAndPlanksWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PiratesAndPlanksWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/PiratesAndPlanksWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/PiratesAndPlanksWLAIW/InitOutcome.xml").getDocumentElement();
